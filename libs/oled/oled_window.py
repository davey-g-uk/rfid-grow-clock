...
class OLEDWindow:
    ...
    def __init__(self, oled, x, y, width, height):
        ...
        self.buffersize = len(self.screenBuffer)
    ...
    def draw_screen_buffer(self):
        ...
        #sbreverse = list(reversed(self.screenBuffer))
        self.oled.writeDataBytes(self.screenBuffer[0:4096])
        self.oled.writeDataBytes(self.screenBuffer[4096:])
        #self.oled.writeDataBytes(sbreverse[0:4096])
        #self.oled.writeDataBytes(sbreverse[4096:])
    ...
    def set_pixel(self, x, y, color):
        ...
        ofs = self.buffersize - ofs
        #print("offset:" + str(ofs))
        if x % 2 == 0:  # even
