...
class OLED:
    ...
    def __init__(self):
        ...
        GPIO.setup(23,GPIO.OUT)   # 25 RESET (low to reset)
        GPIO.output(23,True)      #    Release the RESET
        GPIO.setup(5,GPIO.OUT)   # 24 D/C
        self.spi = spidev.SpiDev()     # Init the spidev module
        self.spi.open(0,1)             # Open the spi device
